    ...
    <div className="group relative rounded-xl border border-slate-200 bg-white overflow-hidden hover:shadow-md transition-all">
      ...
      <div className="p-2.5 flex items-center gap-2">
        ...
        <div className="flex-1 min-w-0">
          <div className="text-xs font-medium text-slate-800 truncate">{att.filename}</div>
        ...
        {signedUrl && (
          <a href={signedUrl} target="_blank" rel="noopener noreferrer" className="shrink-0">
            <Button variant="ghost" size="sm" className="h-7 w-7 p-0 text-slate-400 hover:text-blue-600"><ExternalLink className="h-3.5 w-3.5" /></Button>
          </a>
        )}
      </div>
    </div>
